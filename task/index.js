...
//                             let con = $("#article-content").html();
//                             s=s+con
//                             let insert_sql = "insert into news (title,des,con,time,url,num) values (?,?,?,?,?,?)";
//                             connection.query(insert_sql, [title, des, s, time,url,5], function (error, result, fields) {
//                                 if (error) throw error;
//                             })
//                         }
//                     )
